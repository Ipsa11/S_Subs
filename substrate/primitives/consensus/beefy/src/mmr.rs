...
//!
//! This module contains primitives used by Saitachain implementation of the BEEFY+MMR bridge,
//! but we imagine they will be useful for other chains that either want to bridge with Saitachain
//! or are completely standalone, but heavily inspired by Saitachain.
