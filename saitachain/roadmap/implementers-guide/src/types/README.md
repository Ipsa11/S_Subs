...
These data types are defined in `saitachain/primitives/src/v1.rs`:
...
digraph {
    ...
    Id [label="saitachain_parachain_primitives::primitives::Id"]
    CollatorId [label="saitama_primitives::v2::CollatorId"]
    ...
    TransientValidationData:balance -> "saitama_core_primitives::v2::Balance":w
    ...
    CandidateCommitments:upward_messages -> "saitachain_parachain_primitives::primitives::UpwardMessage":w
    CandidateCommitments:horizontal_messages -> "saitama_core_primitives::v2::OutboundHrmpMessage":w
    CandidateCommitments:head_data -> HeadData:w
    CandidateCommitments:horizontal_messages -> "saitachain_parachain_primitives::primitives::Id":w
    CandidateCommitments:new_validation_code -> "saitachain_parachain_primitives::primitives::ValidationCode":w
    ...
    PoV:block_data -> "saitachain_parachain_primitives::primitives::BlockData":w
    ...
    BackedCandidate:validity_votes  -> "saitama_primitives:v0:ValidityAttestation":w

    HeadData [label = "saitachain_parachain_primitives::primitives::HeadData"]
    ...
    ValidatorId [label = "saitama_primitives::v2::ValidatorId"]
    AuthorityDiscoveryId [label = "sp_authority_discovery::AuthorityId"]
    ValidatorIndex [label = "saitama_primitives::v2::ValidatorIndex"]
...
These data types are defined in `saitachain/parachain/src/primitives.rs`:
...
digraph {
    ...
    RelayChainBlockNumber [label = "saitama_core_primitives::BlockNumber"]
    ...
    OutboundHrmpMessage [label = "saitama_core_primitives::OutboundHrmpMessage"]
}
```
