...
In SaitaChain's security model, it is important that attempts to attack the system result in a slash of the offenders.
...
limit inclusion for exampl in case of high
