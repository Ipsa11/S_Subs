...
pub struct RunCmd {
	...
	/// Force using  native runtime.
	#[arg(long = "force-saitachain")]
	pub force_saitachain: bool,
	...
	/// binary's directory is searched first, then `/usr/lib/saitachain` is searched. TESTING ONLY:
