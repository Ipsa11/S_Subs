...
pub mod currency {
	...
	pub const MILLICENTS: Balance = CENTS / 1_0000; // 100_000
	pub const MILLI: Balance = CENTS * 3;
...
pub mod time {
	...
	// <https://research.web3.foundation/en/latest/saitachain/BABE/Babe/#6-practical-results>
...
pub mod fee {
	...
	impl WeightToFeePolynomial for WeightToFee {
		...
		fn polynomial() -> WeightToFeeCoefficients<Self::Balance> {
			// in SaitaChain, extrinsic base weight (smallest non-zero weight) is mapped to 1/10 CENT:
...
pub mod xcm {
	...
	pub mod body {
		...
		// The bodies corresponding to the SaitaChain OpenGov Origins.
