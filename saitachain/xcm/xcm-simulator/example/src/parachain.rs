...
use saitama_core_primitives::BlockNumber as RelayBlockNumber;
use saitachain_parachain_primitives::primitives::{
...
parameter_types! {
	...
	pub const RelayNetwork: NetworkId = NetworkId::SaitaChain;
...
impl Config for XcmConfig {
	...
	type AssetTrap = ();
	type AssetLocker = SaitaChainXcm;
	type AssetExchanger = ();
	type AssetClaims = ();
...
construct_runtime!(
	pub enum Runtime
	{
		...
		SaitaChainXcm: pallet_xcm::{Pallet, Call, Event<T>, Origin},
