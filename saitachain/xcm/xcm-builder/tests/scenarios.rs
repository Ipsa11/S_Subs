...
use mock::{
	fake_message_hash, saitachain_like_with_balances, AccountId, Balance, Balances, BaseXcmWeight,
...
fn withdraw_and_deposit_works() {
	...
	saitachain_like_with_balances(balances).execute_with(|| {
...
/// Scenario:
/// A parachain wants to move STC  Statemine.
